...
class Formbutton extends FormBase {
  ...
  if($count<1){
    ...
    //$form_state->setRedirectUrl('/editsubmission/{uid}');
...
//  kint($form['actions']['submit_1']['#value']);
//kint($form_state);
//     if($form_state['values']['op'] == 'apply'){
//       $url = Url::fromRoute('/editsubmission/1');
//       $form_state->setRedirectUrl($url);
//
// } else if($form_state['values']['op'] == 'edit profile'){
//   $route = Url::fromRoute('/editsubmission/1');
